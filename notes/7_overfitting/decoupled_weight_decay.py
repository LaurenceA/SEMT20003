...
train(t.optim.AdamW, {'lr': 0.03},                        'tab:orange', 'AdamW; no weight decay', alpha=0.3)
train(t.optim.AdamW, {'lr': 0.03, 'weight_decay': 0.1},  'tab:orange', 'AdamW; weight decay=0.01', alpha=0.6)
train(t.optim.AdamW, {'lr': 0.03, 'weight_decay': 1.},  'tab:orange', 'AdamW; weight decay=0.1')
