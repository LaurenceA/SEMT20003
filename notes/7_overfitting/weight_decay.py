...
train(t.optim.Adam, {'lr': 0.03},                        'tab:orange', 'Adam; no weight decay', alpha=0.3)
train(t.optim.Adam, {'lr': 0.03, 'weight_decay': 0.001}, 'tab:orange', 'Adam; weight decay=0.001', alpha=0.6)
train(t.optim.Adam, {'lr': 0.03, 'weight_decay': 0.01},  'tab:orange', 'Adam; weight decay=0.01')
